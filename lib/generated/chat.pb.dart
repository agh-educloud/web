...
class ChatMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChatMessage')
    ..a<$0.User>(
        1, 'sender', $pb.PbFieldType.OM, $0.User.getDefault, $0.User.create)
    ..a<Message>(
        2, 'message', $pb.PbFieldType.OM, Message.getDefault, Message.create)
    ..hasRequiredFields = false;

  ChatMessage() : super();

  ChatMessage.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  ChatMessage.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
