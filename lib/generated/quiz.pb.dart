...
class QuizQuestion extends $pb.GeneratedMessage {
  ...
  QuizQuestion.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  QuizQuestion.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);

  QuizQuestion clone() => QuizQuestion()..mergeFromMessage(this);

  QuizQuestion copyWith(void Function(QuizQuestion) updates) =>
      super.copyWith((message) => updates(message as QuizQuestion));
  ...
  static $pb.PbList<QuizQuestion> createRepeated() =>
      $pb.PbList<QuizQuestion>();
...
class QuizQuestionCreation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QuizQuestionCreation')
    ..a<QuizQuestion>(1, 'quizQuestion', $pb.PbFieldType.OM,
        QuizQuestion.getDefault, QuizQuestion.create)
    ..a<Option>(
        2, 'answer', $pb.PbFieldType.OM, Option.getDefault, Option.create)
    ..hasRequiredFields = false;

  QuizQuestionCreation() : super();

  QuizQuestionCreation.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  QuizQuestionCreation.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);

  QuizQuestionCreation clone() =>
      QuizQuestionCreation()..mergeFromMessage(this);

  QuizQuestionCreation copyWith(void Function(QuizQuestionCreation) updates) =>
      super.copyWith((message) => updates(message as QuizQuestionCreation));
  ...
  static $pb.PbList<QuizQuestionCreation> createRepeated() =>
      $pb.PbList<QuizQuestionCreation>();

  static QuizQuestionCreation getDefault() =>
      _defaultInstance ??= create()..freeze();
  static QuizQuestionCreation _defaultInstance;

  QuizQuestion get quizQuestion => $_getN(0);

  set quizQuestion(QuizQuestion v) {
    setField(1, v);
  }
...
class QuizQuestionAnswer extends $pb.GeneratedMessage {
  ...
  QuizQuestionAnswer.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  QuizQuestionAnswer.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);

  QuizQuestionAnswer clone() => QuizQuestionAnswer()..mergeFromMessage(this);

  QuizQuestionAnswer copyWith(void Function(QuizQuestionAnswer) updates) =>
      super.copyWith((message) => updates(message as QuizQuestionAnswer));
  ...
  static $pb.PbList<QuizQuestionAnswer> createRepeated() =>
      $pb.PbList<QuizQuestionAnswer>();

  static QuizQuestionAnswer getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class QuizQuestionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QuizQuestionResponse')
    ...
    ..a<Option>(2, 'correctAnswer', $pb.PbFieldType.OM, Option.getDefault,
        Option.create)
    ..hasRequiredFields = false;

  QuizQuestionResponse() : super();

  QuizQuestionResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  QuizQuestionResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);

  QuizQuestionResponse clone() =>
      QuizQuestionResponse()..mergeFromMessage(this);

  QuizQuestionResponse copyWith(void Function(QuizQuestionResponse) updates) =>
      super.copyWith((message) => updates(message as QuizQuestionResponse));
  ...
  static $pb.PbList<QuizQuestionResponse> createRepeated() =>
      $pb.PbList<QuizQuestionResponse>();

  static QuizQuestionResponse getDefault() =>
      _defaultInstance ??= create()..freeze();
  static QuizQuestionResponse _defaultInstance;

  $core.int get questionUuid => $_get(0, 0);

  set questionUuid($core.int v) {
    $_setSignedInt32(0, v);
  }
...
class QuizQuestionStatistics extends $pb.GeneratedMessage {
  ...
  QuizQuestionStatistics.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);

  QuizQuestionStatistics.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);

  QuizQuestionStatistics clone() =>
      QuizQuestionStatistics()..mergeFromMessage(this);

  QuizQuestionStatistics copyWith(
          void Function(QuizQuestionStatistics) updates) =>
      super.copyWith((message) => updates(message as QuizQuestionStatistics));
  ...
  static $pb.PbList<QuizQuestionStatistics> createRepeated() =>
      $pb.PbList<QuizQuestionStatistics>();

  static QuizQuestionStatistics getDefault() =>
      _defaultInstance ??= create()..freeze();
  ...
  set percentageOfCorrectAnswers($core.double v) {
    $_setFloat(1, v);
  }
