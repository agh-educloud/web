                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: RaisedButton(
                              ...
                              child: Text("Dodaj"),
                              onPressed: () {
                                String value = rightOptionController.text
                                    .toString()
                                    .toUpperCase();
                                          ...
                                          content: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      'Pytanie musi zawierać nazwę!\nPrawidłowa odpowiedź może mieć wartość A,B,C lub D!',
                                                  style: TextStyle(
                                                      color: Colors.black),
                                                )
                                              ],
...
Future<RestQuizQuestion> waitForQuizQuestionEdit(
    BuildContext context, RestQuizQuestion questionToEdit) async {
  final questionController = TextEditingController();
  final aOptionController = TextEditingController();
  final bOptionController = TextEditingController();
  final cOptionController = TextEditingController();
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                icon: Icon(Icons.create),
                                labelText: questionToEdit == null ||
                                        questionToEdit.option.length < 2
                                    ? 'B'
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                icon: Icon(Icons.create),
                                labelText: questionToEdit == null ||
                                        questionToEdit.option.length < 3
                                    ? 'C'
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                icon: Icon(Icons.create),
                                labelText: questionToEdit == null ||
                                        questionToEdit.option.length < 4
                                    ? 'D'
  ...
  return AlertDialog(
    content: Container(
        ...
        child: DropdownButton<RestQuizQuestion>(
          items: appData.quizQuestions
              .map(
                  (RestQuizQuestion quiz) => DropdownMenuItem<RestQuizQuestion>(
                        value: quiz,
                        child: Text(
